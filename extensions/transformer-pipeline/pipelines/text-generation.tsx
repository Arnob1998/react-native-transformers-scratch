...
async function init(
  ...
  const modelPath = `${env.localModelPath}/${model_name}`;
  const modelCoreDir = await FileSystem.readDirectoryAsync(modelPath);
  console.log("files in model folder : ", modelCoreDir);
